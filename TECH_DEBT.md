...
Emails already marked Reviewing get sent to Gemini again on each call. Could skip these in the Gemini prompt and just return their previous recommendation based on label state.
